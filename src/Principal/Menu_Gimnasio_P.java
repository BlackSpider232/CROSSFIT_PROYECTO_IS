 ...
 */
public class Menu_Gimnasio_P extends javax.swing.JFrame {

    DefaultTableModel modeloTabla;
    Conectar con = new Conectar();
    Connection cc = con.conexion();
    public Menu_Gimnasio_P() {
    ...
    private String[] getColumnas(){
        String columna[]= new String[]{"NO. DPI","NOMBRE","APELLIDO","DIRECCION","TELEFONO","ESTADO"};
        return columna;
    }
    
    private void setFilas(){
        try{
            String sql = "Select dpi,nombre,apellido,direccion,telefono,estado from participante order by dpi";
    ...
    void borrar (String borrar){
       try{
        ...
        ps.execute();
        JOptionPane.showMessageDialog(null, "El Participante se ha ELIMINADO");
       }
    ...
    private void initComponents() {
        ...
        PActivos = new javax.swing.JLabel();
        TParticipantes = new javax.swing.JLabel();
        ...
        jLabel1.setText("Participantes Activos :");

        jLabel2.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel2.setText("Total de Participantes :");

        PActivos.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        PActivos.setText("0");

        TParticipantes.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        TParticipantes.setText("0");
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(PActivos)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, 122, Short.MAX_VALUE)
                        .addComponent(jLabel2)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(TParticipantes)
                        .addGap(130, 130, 130))))
        );
    ...
    private void btnAñadirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAñadirActionPerformed
        Añadir_participante ap = new Añadir_participante(this,true);
        ap.addWindowListener(new WindowAdapter() {
                    public void windowClosed(WindowEvent e) {
                        ...
                        try{
                            ...
                            Logger.getLogger(Menu_Gimnasio_P.class.getName()).log(Level.SEVERE, null, ex);
                            ex.printStackTrace();
                        }
                    }
           }); 
    ...
    private void btnModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModificarActionPerformed
        Modificar_participante mp = new Modificar_participante(this,true);
        /*ap.addWindowListener(new WindowAdapter() {
                    public void windowClosed(WindowEvent e) {
                        //modeloTabla.setRowCount(0);
                        try{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Menu_Gimnasio_P.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Menu_Gimnasio_P().setVisible(true);
            }
        });
    }

    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JLabel PActivos;
    private javax.swing.JLabel TParticipantes;
