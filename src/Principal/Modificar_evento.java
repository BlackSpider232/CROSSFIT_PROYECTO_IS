 ...
 */
public class Modificar_evento extends javax.swing.JDialog {

    /**
     * Creates new form añadir_particicpante
     */
    public Modificar_evento(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Modificar_evento.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Modificar_evento dialog = new Modificar_evento(new javax.swing.JFrame(), true);
