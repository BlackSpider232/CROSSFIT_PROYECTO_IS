 ...
 */
public class Modificar_participante extends javax.swing.JDialog {

    /**
     * Creates new form añadir_particicpante
     */
    public Modificar_participante(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Modificar_participante.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Modificar_participante dialog = new Modificar_participante(new javax.swing.JFrame(), true);
